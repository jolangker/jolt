...
<template>
  <UDashboardGroup>
    <slot />
    <nav class="fixed bottom-0 left-0 right-0 bg-default z-50 bg-elevated/50 backdrop-blur">
      <div class="flex justify-around items-center h-16">
        ...
        >
          ...
          <UButton
            ...
            variant="solid"
            size="xl"
            class="rounded-full transform -translate-y-4 scale-125 ring-8 ring-(--ui-bg)"
            @click="item.onClick"
          />
        </template>
      </div>
